...
void mcu_init(void) {
  ...
  initial values from the NVM (Non-volatile Memory) User Row and suggest to refer to NVM User Row Mapping
  for more details. 
  
  Bit 25 (WDT Enable) is 0 by default implying WDT is turned off  by default. 
