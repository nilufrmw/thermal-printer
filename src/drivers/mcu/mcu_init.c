...
void mcu_init(void) {
  ...
  initial values from the NVM User Row and suggest to refer to NVM (Non-volatile Memory)
  User Row Mapping for more details. 
  
  Bit 25 (WDT Enable) is 0 by default implies WDT is turned off  by default. 
